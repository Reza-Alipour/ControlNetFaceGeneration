...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default='reza-alipour/Controlnet-Segmentation',
    ...
    parser.add_argument("--hub_read_token", type=str, default='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',
                        help="The token to use to read pretrained model and dataset.")
    parser.add_argument(
        "--hub_model_id",
        type=str,
        default=None,
    ...
    parser.add_argument("--text_prompt", type=str, default='She has black hair.')
    parser.add_argument(
    ...
    parser.add_argument("--alpha", type=int, nargs='+', type=float, default=[0.8, 0.9, 1, 1.1])
    parser.add_argument("--num_inference_steps", type=int, nargs='+', type=float, default=[20, 40, 50])
