###########################################################################################################################
#####                                                                                                                 #####
#####  This file is an adaptation of the `run_semantic_segmentation.py` script from the huggingface/transformers repo  #####
#####                                                                                                                 #####
###########################################################################################################################
...
def main():
    ...
    train_transforms = Compose(
        [
            ...
            # RandomHorizontalFlip(flip_prob=0.5), Disabled due to importance of right and left in segmentation
            PILToTensor(),
